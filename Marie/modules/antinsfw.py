...
from Marie import pbot, arq, BOT_USERNAME as bn
from Marie.utils.errors import capture_err
from Marie.utils.permissions import adminsOnly
from Marie.services.dbfunctions import is_nsfw_on, nsfw_off, nsfw_on


__help__ = """
 » `/nsfwscan` <reply to a sticker> : Check Adult Contents
 » `/antinsfw`  [on/off] : It Will Stop The Allowance Of Adult Content In Group 
 """
