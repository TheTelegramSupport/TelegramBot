...
from Marie.modules.disable import DisableAbleMessageHandler
from Marie.modules.helper_funcs.regex_helper import infinite_loop_check
        ...
        try:
            ...
            if check and check.group(0).lower() == to_fix.lower():
                update.effective_message.reply_to_message.reply_text(
                    ...
                    "Say Dear ... Okay!".format(update.effective_user.first_name)
                )
                return
            ...
            update.effective_message.reply_text("Do You Even Sed? Apparently Not.. Dear .")
            return
