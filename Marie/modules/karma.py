...
from Marie import pbot as app, BOT_ID
from Marie.utils.errors import capture_err
from Marie.utils.permissions import adminsOnly
from Marie.services.dbfunctions import (
    alpha_to_int,
    get_karma,
    get_karmas,
    int_to_alpha,
...
from Marie.utils.filter_groups import karma_negative_group, karma_positive_group
from Marie import arq
...
async def upvote(_, message):
    ...
    await message.reply_text(
        f"Incremented Karna Of {user_mention} By 1 \nTotal Point: {karma} .."
    )
...
async def karma(_, message):
    ...
    if not message.reply_to_message:
        m = await message.reply_text("Analyzing Karma....Wll Take 10 Second")
