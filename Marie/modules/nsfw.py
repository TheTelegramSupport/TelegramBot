...
from Marie import dispatcher, updater
import Marie.modules.sql.nsfw_sql as sql
...
__help__ = """
*NSFW:*
» `/addnsfw` : Enable NSFW Modde
» `/rmnsfw` : Disable NSFW Modde

Available Commands:
» `/neko`: Sends Random SFW Neko Source Image.
» `/ngif`: Sends Random Neko Gifs.
» `/tickle`: Sends Random Tickle Gifs.
» `/waifu`: ꜱᴛɪᴄᴋᴇʀꜱ Sends Random Waifu Stickers.
