...
from Marie import telethn as borg, HEROKU_APP_NAME, HEROKU_API_KEY, OWNER_ID
...
async def variable(var):
    ...
    if exe == "see":
        ...
        s = await var.reply("`Setting Information...Wait`")
        variable = var.pattern_match.group(2)
        if not variable:
            return await s.edit(">`.ꜱᴇᴛ ᴠᴀʀ Set Var <Configvars-Name> <Value> ..`")
        ...
        if variable in heroku_var:
            ...
            return await m.edit(f"**{variable}**  `Is Not Exist`")
