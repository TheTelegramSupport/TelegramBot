...
from Marie import OWNER_ID, BOT_USERNAME, BOT_NAME
...
async def lego(event):
 ...
 try:
    ...
    fillcolor = "black"
    shadowcolor = "blue"
    fnt = glob.glob("./Marie/MarieFont/logofonts/*")
    ...
    await event.reply(f'Error, Report To @{SUPPORT_CHAT}  ..')
...
async def lego(event):
 ...
 try:
    text = event.pattern_match.group(1)
    img = Image.open('./Marie/MarieFont/blackbg.jpg')
    draw = ImageDraw.Draw(img)
    image_widthz, image_heightz = img.size
    pointsize = 500
    fillcolor = "black"
...
__help__ = """
 » `/logo` <text> :  Create Your Logo With Your Name With Multiple Background 
