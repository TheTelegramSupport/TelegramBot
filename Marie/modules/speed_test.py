...
from Marie import DEV_USERS, dispatcher
from Marie.modules.disable import DisableAbleCommandHandler
from Marie.modules.helper_funcs.chat_status import dev_plus
...
def speedtestxyz_callback(update: Update, context: CallbackContext):
    ...
    if query.from_user.id in DEV_USERS:
        msg = update.effective_message.edit_text("Running A Speed Test...")
        ...
        query.answer("ʏᴏᴜ ᴀʀᴇ ʀᴇQᴜɪʀᴇᴅ ᴛᴏ ᴊᴏɪɴ You Are ReQuired To Join @MarieSupportChat To Use This Command.")
