...
from Marie import dispatcher, LOGGER, OWNER_ID, JOIN_LOGGER, SUPPORT_CHAT
from Marie.__main__ import DATA_IMPORT
from Marie.modules.helper_funcs.chat_status import user_admin
from Marie.modules.helper_funcs.alternate import typing_action

# from Marie.modules.rules import get_rules
import Marie.modules.sql.rules_sql as rulessql

# from Marie.modules.sql import warns_sql as warnssql
import Marie.modules.sql.blacklist_sql as blacklistsql
from Marie.modules.sql import disable_sql as disabledsql

# from Marie.modules.sql import cust_filters_sql as filtersql
# import Marie.modules.sql.welcome_sql as welcsql
import Marie.modules.sql.locks_sql as locksql
...
def export_data(update, context):
    ...
    with open("Marie{}.backup".format(chat_id), "w") as f:
    ...
    context.bot.sendDocument(
        current_chat_id,
        document=open("Marie{}.backup".format(chat_id), "rb"),
        caption="*Successfully Exported Backup:*\nChat: `{}`\nChat ID: `{}`\mOn: `{}`\n\nNote: This `Marie-Backup` Was Specially Made For Notes.".format(
            chat.title,
            chat_id,
            tgl,
        ),
    ...
    os.remove("Marie{}.backup".format(chat_id))  # Cleaning file
