...
import jikanpy
import requests
from Marie import DEV_USERS, OWNER_ID, DRAGONS, dispatcher
...
def site_search(update: Update, context: CallbackContext, site: str):
    ...
    try:
        ...
        message.reply_text("Give Somthing To Search")
        return
...
» `/character` <Character>: Returns Information About Character.
» `/manga` <Manga>: Returns Information About The Manga.
» `/user` <ᴜꜱᴇʀ>: Returns Information About A MyAnimeList User.
» `/airing` <Anime>: Returns Anime Airing Information.
