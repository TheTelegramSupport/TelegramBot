...
def removetiger(update: Update, context: CallbackContext) -> str:
    ...
    if user_id in TIGERS:
        message.reply_text("ᴅᴇᴍᴏᴛɪɴɢ ᴛᴏ ɴᴏʀᴍᴀʟ User ʙᴀʙʏ🥀")
        ...
        message.reply_text("ᴛʜɪꜱ User ɪꜱ ɴᴏᴛ ᴀ ᴛɪɢᴇʀ ᴅɪꜱᴀꜱᴛᴇʀ ʙᴀʙʏ🥀!")
        return ""
...
def tigerlist(update: Update, context: CallbackContext):
    reply = "<b>ᴋɴᴏᴡɴ ᴛɪɢᴇʀ Disaster  🐯:</b>\n"
    bot = context.bot
...
def supportlist(update: Update, context: CallbackContext):
    bot = context.bot
    reply = "<b>ᴋɴᴏᴡɴ ᴅᴇᴍᴏɴ Disaster  👹:</b>\n"
...
def sudolist(update: Update, context: CallbackContext):
    ...
    reply = "<b>ᴋɴᴏᴡɴ ᴅʀᴀɢᴏɴ Disaster  🐉:</b>\n"
...
Group Adminꜱ/Group-Owners Do Not Need These Commands.
 *List all special users:*
 » `/dragons`*:* Lists All Dragons Disaster 
 » `/dragons`*:*Lists All Demons Disaster 
 » `/tigers`*:* Lists All Tigers Disaster 
 » `/wolves`*:* Lists All Wolf Disaster 
 » `/heroes`*:* Lists All Hero Disaster  Members 
  *Ping:*
 ...
 » `/broadcastusers`*:* Broadcast To All Userꜱ
 ...
 *Module loading:*
 » `/listmodules`*:* Lists Name Of All Modules 
 » `/load` modulename*:* Loads The Said Module To Memory Without Restarting.
 » `/unload` modulename*:* Loads The Said Module To Memory Without Restarting The Bot
 *Windows self hosted only:*
 » `/reboot`*:* Restart The Bots Service 
 » `/gitpull`*:* Pulls The Repo And Then Restarts The Bots Service 
 *Debugging And Shell:* 
 » `/debug` <on/off>*:* Logs Commands To Updates.TXT
 » `/logs`*:* Run This Support Group To Get Logs In Pm
